...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-white relative pt-24 pb-8 overflow-hidden">
      ...
      <button
        onClick={scrollToTop}
        className="absolute top-12 right-8 lg:right-12 bg-white text-primary p-4 hover:bg-accent hover:text-primary transition-colors duration-300 shadow-xl cursor-pointer rounded-full z-20"
      ...
      <div className="w-full overflow-hidden mb-16 pointer-events-none select-none px-4 sm:px-8 lg:px-12 flex justify-center">
        <h2 className="text-[14vw] font-black leading-[0.8] tracking-tighter text-white/5 font-sans whitespace-nowrap">
          VULPINE LIMITED
        </h2>
      </div>
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-4 space-y-8 pr-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:bg-accent hover:text-primary hover:border-accent transition-all duration-300">
          ...
          <div className="lg:col-span-3">
            <h4 className="text-[10px] font-black tracking-[0.2em] text-accent uppercase mb-8 font-sans">Our Services</h4>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-[10px] font-black tracking-[0.2em] text-accent uppercase mb-8 font-sans">Quick Links</h4>
            <ul className="space-y-4 text-sm text-white/70 font-sans font-medium">
          ...
          <div className="lg:col-span-3 space-y-6 text-sm text-white/70 font-sans font-medium">
            <h4 className="text-[10px] font-black tracking-[0.2em] text-accent uppercase mb-8">Contact Info</h4>
            ...
            <div className="flex items-start space-x-4 pt-4 border-t border-white/10">
              <div className="text-accent font-black tracking-widest shrink-0 text-xs mt-0.5">P.O. BOX</div>
        ...
        {/* Bottom Bar Divider */}
        <div className="mt-8 flex flex-col md:flex-row items-center justify-between text-[11px] font-black tracking-widest uppercase text-white/40 font-sans gap-4">
