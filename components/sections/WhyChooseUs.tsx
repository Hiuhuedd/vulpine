...
export default function WhyChooseUs({ data }: WhyChooseUsProps) {
  ...
  return (
    <section className="bg-light-green text-primary py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-slate-200/50 rounded-sm blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/3 lg:sticky lg:top-32 h-fit">
            ...
            <h2 className="font-serif text-3xl sm:text-3xl lg:text-3xl font-bold tracking-tight mb-6 leading-tight text-primary">
              ...
              {items.map((strength: any, index: number) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-surface border border-slate-200 p-8 rounded-sm hover:shadow-lg hover:border-slate-300 hover:-translate-y-2 transition-all duration-300 group"
                  >
                    <div className="w-14 h-14 rounded-sm bg-slate-50 border border-slate-100 text-accent flex items-center justify-center group-hover:scale-110 group-hover:bg-accent group-hover:text-primary transition-all duration-500 mb-6">
                      <Icon size={24} />
                    </div>
