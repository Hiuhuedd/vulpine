    ...
    <section className="bg-white py-32 relative border-t border-slate-100">
      <div className="w-full">
        ...
        <div className="max-w-[90rem] mx-auto px-4 sm:px-8 lg:px-12 mb-20 flex flex-col md:flex-row md:items-end justify-between gap-10">
          <div>
            <span className="text-[10px] font-bold tracking-[0.2em] text-accent uppercase mb-6 bg-primary text-white inline-block px-4 py-2">
              Portfolio
            </span>
          ...
          <Link
            href="/projects"
            className="group relative inline-flex items-center justify-center px-8 py-4 font-sans font-bold text-primary bg-surface border border-slate-200 rounded-sm overflow-hidden transition-transform hover:scale-105 active:scale-95 shadow-sm"
          >
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-5/12 p-10 sm:p-14 lg:p-20 flex flex-col justify-center bg-surface lg:border-r border-slate-100 z-10 transition-colors duration-500 relative">
                <div className="absolute top-0 right-0 p-8 text-[5rem] font-bold leading-none text-slate-100 select-none pointer-events-none group-hover:text-accent/10 transition-colors duration-500">
                  0{index + 1}
                </div>
                
                <div className="relative z-10">
                  <div className="text-[10px] font-bold tracking-[0.2em] text-accent uppercase font-sans mb-8 border border-slate-200 bg-white inline-block px-4 py-2 shadow-sm">
                    {project.category}
                  </div>
                  <h3 className="font-sans text-3xl sm:text-3xl text-primary font-bold tracking-tighter mb-6 group-hover:text-accent transition-colors leading-[0.95]">
                    {project.title}
                  </h3>
                ...
                <div className="flex flex-col space-y-4 text-[10px] tracking-widest uppercase text-slate-400 font-sans pt-8 border-t border-slate-200 font-bold relative z-10">
